...
<div id="login"><h1><a href="<?php echo apply_filters('login_headerurl', 'http://www.xe23.com/'); ?>" title="<?php echo apply_filters('login_headertitle', __('Powered by WordPress')); ?>"><?php bloginfo('name'); ?></a></h1>
<?php
