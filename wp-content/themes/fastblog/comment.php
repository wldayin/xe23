...
<li id="comment-<?php comment_ID(); ?>" class="comment">
  ...
  <div class="meta">
    <?php echo get_avatar( $comment, 32, get_option('avatar_default') == 'mystery' ? get_bloginfo( 'stylesheet_directory' ).'/schemes/'.fastblog_get_option( 'scheme' ).'/images/avatar.png' : '' ); ?>
    <div>
